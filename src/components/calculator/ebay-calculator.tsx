...
export function EbayCalculator() {
  ...
  // Get eBay fees from constants
  const ebayTemplate = DEFAULT_PLATFORM_TEMPLATES.ebay;
  ...
  }, [productCost, salePrice, shippingCost, sellerPaysShipping, isVatRegistered, ebayTemplate.fees]);
    ...
    <div className="grid gap-6 lg:grid-cols-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Based on eBay&apos;s current fee structure</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {/* Main Profit/Margin */}
          ...
          {/* Fees Breakdown */}
          <div>
            <h4 className="mb-3 text-sm font-medium">eBay Fees Breakdown</h4>
            <div className="space-y-2">
