...
export function AmazonCalculator() {
  ...
  // Get Amazon fees from constants
  const amazonTemplate = DEFAULT_PLATFORM_TEMPLATES.amazon;
  ...
  }, [productCost, salePrice, shippingCost, sellerPaysShipping, isVatRegistered, amazonTemplate.fees]);
    ...
    <div className="grid gap-6 lg:grid-cols-2">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              FBA shipping to customer or your fulfillment cost
            </p>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Based on Amazon&apos;s current fee structure</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {/* Main Profit/Margin */}
          ...
          {/* Fees Breakdown */}
          <div>
            <h4 className="mb-3 text-sm font-medium">Amazon Fees Breakdown</h4>
            <div className="space-y-2">
