...
export function ShopifyCalculator() {
  ...
  // Get Shopify fees from constants
  const shopifyTemplate = DEFAULT_PLATFORM_TEMPLATES.shopify;
  ...
  }, [productCost, salePrice, shippingCost, sellerPaysShipping, isVatRegistered, shopifyTemplate.fees]);
    ...
    <div className="grid gap-6 lg:grid-cols-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Based on Shopify&apos;s current fee structure</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {/* Main Profit/Margin */}
          ...
          {/* Fees Breakdown */}
          <div>
            <h4 className="mb-3 text-sm font-medium">Shopify Fees Breakdown</h4>
            <div className="space-y-2">
