...
import { formatCurrency, toMinorUnits, toMajorUnits } from '@/lib/constants/currencies';
...
export function TiktokCalculator() {
  ...
  // Get TikTok Shop fees from constants
  const tiktokTemplate = DEFAULT_PLATFORM_TEMPLATES.tiktok;
  ...
  }, [productCost, salePrice, shippingCost, sellerPaysShipping, isVatRegistered, tiktokTemplate.fees]);
    ...
    <div className="grid gap-6 lg:grid-cols-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Based on TikTok Shop&apos;s current fee structure</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {/* Main Profit/Margin */}
          ...
          {/* Fees Breakdown */}
          <div>
            <h4 className="mb-3 text-sm font-medium">TikTok Shop Fees Breakdown</h4>
            <div className="space-y-2">
